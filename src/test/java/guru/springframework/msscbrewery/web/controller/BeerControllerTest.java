        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}" , validBeer.getId().toString()).accept(MediaType.APPLICATION_JSON))
                ...
                .andDo(document("v1/beer-get",
                        ...
                        responseFields(
                                ...
                                fields.withPath("lastUpdatedDate").description("Last modification date").type(OffsetDateTime.class),
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-new",
                    requestFields(
                            ...
                            fields.withPath("lastUpdatedDate").description("Last modification date").ignored(),
                            fields.withPath("beerName").description("Name of the beer").type(String.class),
                            fields.withPath("upc").description("UPC of the beer").type(Long.class),
                            fields.withPath("beerStyle").description("Style of the beer").type(String.class)
                    )));
